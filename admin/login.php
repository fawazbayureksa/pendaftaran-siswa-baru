...
if (isset($_POST['login'])) {
    ...
    $query = mysqli_query($db,"SELECT * FROM user WHERE username='$_POST[username]' AND password = '$_POST[password]'");
    ...
    if ($cek == 1) {
        ...
        echo "<script>alert('Login Admin Gagal , Periksa akun anda') </script>";
